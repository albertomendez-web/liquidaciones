const I18N = {
  ...
  'inv.footerNote':     { es:'Este documento constituye la liquidaci\u00f3n mensual de gesti\u00f3n de alquiler vacacional conforme al contrato de gesti\u00f3n suscrito entre las partes.', en:'This document constitutes the monthly vacation rental management settlement pursuant to the management contract between the parties.', de:'Dieses Dokument stellt die monatliche Abrechnung der Ferienvermietungsverwaltung gem\u00e4\u00df dem zwischen den Parteien geschlossenen Verwaltungsvertrag dar.' },
