 ...
 *  LIQUIDACIONES — Gesti\u00f3n de Reservas Vacacionales
 *  Aplicaci\u00f3n SPA (Single Page Application) en archivo \u00fanico
 ...
 * ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡  ARCHITECTURE GUIDE — Documentaci\u00f3n interna para Claude / AI Assistants    ÃƒÂ¢Ã¢â‚¬ÂÃ¢â‚¬Å¡
 ...
 * ============================================================================
 * Sistema de liquidaci\u00f3n financiera para empresa de gesti\u00f3n de propiedades
 ...
 *   - Comisiones por plataforma (Airbnb, Booking, etc.) y gesti\u00f3n GTC
 *   - Limpieza, amenities, pasarela de pago
 *   - Conceptos extraordinarios con IVA (CE) y sin IVA (CE2)
 *   - Retenci\u00f3n IRPF e IVA 21% sobre subtotal
 *   - Reparto especial 80/20 GTC para propiedades con m\u00ednimo garantizado
 ...
 *   list          ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Preliquidaci\u00f3n: tabla con todas las reservas + filtros
 *   detail        ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Detalle de una reserva individual (preliquidaci\u00f3n)
 *   consol        ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Grid de tarjetas por alojamiento (vista consolidada)
 *   consoldetail  ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ Liquidaci\u00f3n completa de un alojamiento (tabla + resumen)
 *
 * ============================================================================
 * 3. MODELO DE DATOS (variables globales principales)
 * ============================================================================
 *
 *   allReservas[]  — Array de objetos reserva. Cada reserva tiene:
 *     .idx           ÃƒÆ’Ã‚Ândice en el array (clave primaria interna)
 *     .id            ID Reserva (string del Sheet)
 *     .localizador   C\u00f3digo localizador
 *     .cliente       Nombre del cliente
 *     .alojamiento   C\u00f3digo del alojamiento (ej: "MA-2-P2-1A")
 *     .edificio      Nombre del edificio
 *     .plataforma    Canal de venta ("Booking.com", "Airbnb.com", etc.)
 *     .totalReserva  Importe total con IVA (n\u00famero)
 ...
 *     ._nights       N\u00famero de noches calculado
 *     ._sheetRow     Fila 1-indexed en el Sheet (para write-back)
 *     ._clienteLc/_alojLc/_platLc  Versiones lowercase para b\u00fasqueda
 *     ._isBooking    Boolean: Ãƒâ€šÃ‚Â¿es Booking.com?
 *
 *   settings{}     — Objeto indexado por reserva.idx. Cada entrada tiene:
 *     .comPlataforma   Comisi\u00f3n plataforma (decimal, ej: 0.155 = 15.5%)
 *     .comGTC          Comisi\u00f3n GTC (decimal)
 *     .limpieza        Importe fijo limpieza (ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬)
 *     .amenities       Importe fijo amenities (ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬)
 *     .irpf            Retenci\u00f3n IRPF (decimal)
 ...
 *
 *   validated      — Set<idx>: \u00edndices de reservas validadas
 *
 * ============================================================================
 ...
 *   baseSinIVA    = total / (1 + 0.10)              // IVA tur\u00edstico 10%
 *   comPlat       = total ÃƒÆ’Ã¢â‚¬â€ comRate                  // comisi\u00f3n plataforma
 *   comGTC        = baseSinIVA ÃƒÆ’Ã¢â‚¬â€ gtcRate             // comisi\u00f3n gesti\u00f3n
 ...
 *   ret = sub ÃƒÆ’Ã¢â‚¬â€ irpfRate    // Retenci\u00f3n IRPF
 ...
 *   4. loadOrCreateConfigTab() ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ carga pesta\u00f1a "Configuracion"
 ...
 * ============================================================================
 *   _liqCache{}          — C\u00e1lculos por reserva (invalidateCache)
 *   _cachedFiltered      — Resultado filtrado+ordenado (invalidateFilterCache)
 *   _cachedFilteredStats — Estad\u00edsticas filtradas
 *   _globalStatsCache    — Estad\u00edsticas globales (invalidateGlobalStats)
 *   _selectCache{}       — HTML de <select> preconstruidos
 *   _alojCache           — Agrupaci\u00f3n por alojamiento
 *   _fmtCache{}          — Formateo num\u00e9rico
 *
 *   Patr\u00f3n delta: changeSetting() ÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢ actualiza cache incremental
 ...
 * ============================================================================
 *   [M01] VERSIONING      — APP_VERSION, CHANGELOG, toast actualizaci\u00f3n
 *   [M02] UTILITIES       — esc(), SafeStorage, debounce(), safeGet()
 *   [M03] CONFIG          — CONFIG object, constantes de la aplicaci\u00f3n
 *   [M04] TOAST           — showToast() - notificaciones no bloqueantes
 *   [M05] GOOGLE_AUTH     — OAuth, tokens, estado de conexi\u00f3n
 *   [M06] GOOGLE_SHEETS   — Carga datos, write-back, config persistence
 *   [M07] PROPIETARIOS    — Mapeo alojamientoÃƒÂ¢Ã¢â‚¬Â Ã¢â‚¬â„¢propietario, edici\u00f3n inline
 *   [M08] DATA_MODEL      — allReservas, settings, opciones globales
 *   [M09] CALCULATIONS    — calcLiquidacion, parseNum, fmt()
 *   [M10] SEARCH_FILTER   — B\u00fasqueda, filtrado, combos, month picker
 *   [M11] TABLE_RENDER    — renderTable, columnas, paginaci\u00f3n, footer
 *   [M12] CE_SYSTEM       — Conceptos extraordinarios (CE + CE2)
 *   [M13] DETAIL_VIEW     — Vista detalle individual
 *   [M14] CONSOL_VIEW     — Vista consolidada por alojamiento
 *   [M15] CONSOL_DEDUCT   — Mantenimiento y extras mensuales
 *   [M16] PRINT           — Generaci\u00f3n impresi\u00f3n y preview
 *   [M17] SETTINGS_UI     — Modal configuraci\u00f3n, opciones editables
 *   [M18] AI_ASSISTANT    — Chat IA integrado
 *
 * ============================================================================
 ...
 *   - Vista 'p' = preliquidaci\u00f3n, 'c' = consolidada (en IDs de CE)
 *   - SemVer obligatorio en cada entrega (ver VERSIONING RULES)
 *
 * ============================================================================
 * 9. ESTRUCTURA HTML (fuera del <script>)
 * ============================================================================
 *   <div class="sidebar">         — Navegaci\u00f3n lateral fija
 *   <div class="main">            — Contenido principal con pantallas
 *     #screen-upload              — Carga de datos
 *     #screen-list                — Preliquidaci\u00f3n (tabla + filtros)
 *     #screen-detail              — Detalle individual
 *     #screen-consol              — Grid alojamientos
 *     #screen-consoldetail        — Liquidaci\u00f3n consolidada
 *   <div id="config-modal">       — Modal de configuraci\u00f3n
 *   <div class="ai-panel">        — Panel lateral IA
 *   <div class="changelog-overlay"> — Modal historial de cambios
 */
...
//  [M01] VERSIONING — Control de versiones, CHANGELOG y notificaciones
// ÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚Â
// ===
// CONTROL DE VERSIONES
// ===
// ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ [M10-SEARCH] Funciones de b\u00fasqueda global (se necesitan antes del render) ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬ÃƒÂ¢Ã¢â‚¬ÂÃ¢â€šÂ¬

/** @description Filtra la tabla de preliquidaci\u00f3n por texto libre en tiempo real */
...
/** @description Limpia el filtro de b\u00fasqueda de preliquidaci\u00f3n */
...
/** @description Limpia el filtro de b\u00fasqueda del grid consolidado */
...
/**
 * ===================================================================================================
 *  VERSIONING RULES ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â OBLIGATORIO en CADA entrega de c\u00f3digo
 * ===================================================================================================
 *  MAJOR (X.0.0)  ->  Cambios incompatibles, reestructuraci\u00f3n total,
 *                   migraci\u00f3n de datos necesaria
 *  MINOR (x.Y.0)  ->  Nueva funcionalidad, nueva secci\u00f3n UI,
 *                   nuevo campo/columna, nueva integraci\u00f3n
 *  PATCH (x.y.Z)  ->  Bugfix, ajuste visual, optimizaci\u00f3n,
 *                   refactor sin cambio funcional
 * ===================================================================================================
 *  CHECKLIST por entrega:
 *  ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ 1. Leer versi\u00f3n actual de APP_VERSION
 *  ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ 2. Decidir bump: MAJOR / MINOR / PATCH
 *  ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ 3. Actualizar APP_VERSION con nueva versi\u00f3n
 *  ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ 4. Actualizar APP_BUILD con fecha/hora actual Madrid (+01/+02)
 *  ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ 7. NUNCA reutilizar un n\u00famero de versi\u00f3n ya existente
 * ===================================================================================================
 */
...
// ÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚Â
//  [M02] UTILITIES — Funciones auxiliares reutilizables
// ÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚Â
